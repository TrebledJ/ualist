...
var $author$project$View$Flags = function (width) {
	return {width: width};
};
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$View$flagDecoder = A2(
	$elm$json$Json$Decode$map,
	$author$project$View$Flags,
	A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int));
var $author$project$Components$Clipboard$Idle = {$: 'Idle'};
var $author$project$Components$UaTable$ClipboardMsg = function (a) {
	return {$: 'ClipboardMsg', a: a};
};
var $author$project$Components$Clipboard$CopyAction = function (a) {
	return {$: 'CopyAction', a: a};
};
var $author$project$Components$UaTable$OnRowClick = function (a) {
	return {$: 'OnRowClick', a: a};
};
var $author$project$Components$UaTable$OnTable = function (a) {
	return {$: 'OnTable', a: a};
};
var $author$project$Util$applyIfT = F3(
	function (cond, f, x) {
		return cond ? f(x) : x;
	});
...
var $author$project$TwUtil$border = _List_fromArray(
	[
		...
		$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$gray_300),
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$clipboardCheck = A4(
	$lattyware$elm_fontawesome$FontAwesome$IconDef,
	'fas',
	'clipboard-check',
	_Utils_Tuple2(384, 512),
	_Utils_Tuple2('M192 0c-41.8 0-77.4 26.7-90.5 64L64 64C28.7 64 0 92.7 0 128L0 448c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64l-37.5 0C269.4 26.7 233.8 0 192 0zm0 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zM305 273L177 401c-9.4 9.4-24.6 9.4-33.9 0L79 337c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L271 239c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z', $elm$core$Maybe$Nothing));
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$clipboardCheck = $lattyware$elm_fontawesome$FontAwesome$present($lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$clipboardCheck);
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$clipboardList = A4(
	$lattyware$elm_fontawesome$FontAwesome$IconDef,
	'fas',
	'clipboard-list',
	_Utils_Tuple2(384, 512),
	_Utils_Tuple2('M192 0c-41.8 0-77.4 26.7-90.5 64L64 64C28.7 64 0 92.7 0 128L0 448c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64l-37.5 0C269.4 26.7 233.8 0 192 0zm0 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zM72 272a24 24 0 1 1 48 0 24 24 0 1 1 -48 0zm104-16l128 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-128 0c-8.8 0-16-7.2-16-16s7.2-16 16-16zM72 368a24 24 0 1 1 48 0 24 24 0 1 1 -48 0zm88 0c0-8.8 7.2-16 16-16l128 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-128 0c-8.8 0-16-7.2-16-16z', $elm$core$Maybe$Nothing));
var $lattyware$elm_fontawesome$FontAwesome$Solid$clipboardList = $lattyware$elm_fontawesome$FontAwesome$present($lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$clipboardList);
...
var $author$project$Components$UaTable$OnFetchUserAgentsClicked = {$: 'OnFetchUserAgentsClicked'};
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Theme$gray_100 = A5($matheus23$elm_tailwind_modules_base$Tailwind$Color$Color, 'rgb', '243', '244', '246', $matheus23$elm_tailwind_modules_base$Tailwind$Color$ViaVariable);
...
var $author$project$TwUtil$iconWithSize = F3(
	function (width, height, base) {
...
var $author$project$TwUtil$icon = A2($author$project$TwUtil$iconWithSize, 20, 20);
...
var $author$project$Components$UaTable$fetchUaButton = function (_v0) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$button,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Components$UaTable$OnFetchUserAgentsClicked),
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$h_10,
							...
							_List_fromArray(
								[
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$gray_100)
								]))
						]),
					$author$project$TwUtil$border))
			]),
		_List_fromArray(
			[
				$author$project$TwUtil$icon($lattyware$elm_fontawesome$FontAwesome$Solid$cloudArrowDown)
			]));
};
var $author$project$TwUtil$Left = {$: 'Left'};
var $author$project$Components$UaTable$OnGenerateClicked = {$: 'OnGenerateClicked'};
var $author$project$Components$UaTable$UpdateToolbarState = function (a) {
	return {$: 'UpdateToolbarState', a: a};
};
var $author$project$Util$appendIfT = F3(
	function (cond, ys, xs) {
		return cond ? _Utils_ap(xs, ys) : xs;
	});
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$arrowRight = A4(
	$lattyware$elm_fontawesome$FontAwesome$IconDef,
	'fas',
	'arrow-right',
	_Utils_Tuple2(448, 512),
	_Utils_Tuple2('M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z', $elm$core$Maybe$Nothing));
var $lattyware$elm_fontawesome$FontAwesome$Solid$arrowRight = $lattyware$elm_fontawesome$FontAwesome$present($lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$arrowRight);
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_t_color = function (color) {
	return A4(
		$matheus23$elm_tailwind_modules_base$Tailwind$Color$propertyWithColor,
		'border-top-color',
		function (c) {
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$globe = A4(
	...
	'globe',
	_Utils_Tuple2(512, 512),
	_Utils_Tuple2('M352 256c0 22.2-1.2 43.6-3.3 64l-185.3 0c-2.2-20.4-3.3-41.8-3.3-64s1.2-43.6 3.3-64l185.3 0c2.2 20.4 3.3 41.8 3.3 64zm28.8-64l123.1 0c5.3 20.5 8.1 41.9 8.1 64s-2.8 43.5-8.1 64l-123.1 0c2.1-20.6 3.2-42 3.2-64s-1.1-43.4-3.2-64zm112.6-32l-116.7 0c-10-63.9-29.8-117.4-55.3-151.6c78.3 20.7 142 77.5 171.9 151.6zm-149.1 0l-176.6 0c6.1-36.4 15.5-68.6 27-94.7c10.5-23.6 22.2-40.7 33.5-51.5C239.4 3.2 248.7 0 256 0s16.6 3.2 27.8 13.8c11.3 10.8 23 27.9 33.5 51.5c11.6 26 20.9 58.2 27 94.7zm-209 0L18.6 160C48.6 85.9 112.2 29.1 190.6 8.4C165.1 42.6 145.3 96.1 135.3 160zM8.1 192l123.1 0c-2.1 20.6-3.2 42-3.2 64s1.1 43.4 3.2 64L8.1 320C2.8 299.5 0 278.1 0 256s2.8-43.5 8.1-64zM194.7 446.6c-11.6-26-20.9-58.2-27-94.6l176.6 0c-6.1 36.4-15.5 68.6-27 94.6c-10.5 23.6-22.2 40.7-33.5 51.5C272.6 508.8 263.3 512 256 512s-16.6-3.2-27.8-13.8c-11.3-10.8-23-27.9-33.5-51.5zM135.3 352c10 63.9 29.8 117.4 55.3 151.6C112.2 482.9 48.6 426.1 18.6 352l116.7 0zm358.1 0c-30 74.1-93.6 130.9-171.9 151.6c25.5-34.2 45.2-87.7 55.3-151.6l116.7 0z', $elm$core$Maybe$Nothing));
...
var $author$project$Util$iff = F3(
	function (cond, a, b) {
		return cond ? a : b;
	});
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$justify_start = A2($rtfeldman$elm_css$Css$property, 'justify-content', 'flex-start');
var $author$project$Components$UaTable$mkPipe = F3(
	function (fmsg, model, transform) {
		return fmsg(
			transform(model));
	});
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$ml_2 = A2($rtfeldman$elm_css$Css$property, 'margin-left', '0.5rem');
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$mobile = A4(
	$lattyware$elm_fontawesome$FontAwesome$IconDef,
	'fas',
	'mobile',
	_Utils_Tuple2(384, 512),
	_Utils_Tuple2('M80 0C44.7 0 16 28.7 16 64l0 384c0 35.3 28.7 64 64 64l224 0c35.3 0 64-28.7 64-64l0-384c0-35.3-28.7-64-64-64L80 0zm80 432l64 0c8.8 0 16 7.2 16 16s-7.2 16-16 16l-64 0c-8.8 0-16-7.2-16-16s7.2-16 16-16z', $elm$core$Maybe$Nothing));
var $lattyware$elm_fontawesome$FontAwesome$Solid$mobile = $lattyware$elm_fontawesome$FontAwesome$present($lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$mobile);
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$rocket = A4(
	$lattyware$elm_fontawesome$FontAwesome$IconDef,
	'fas',
	'rocket',
	_Utils_Tuple2(512, 512),
	_Utils_Tuple2('M156.6 384.9L125.7 354c-8.5-8.5-11.5-20.8-7.7-32.2c3-8.9 7-20.5 11.8-33.8L24 288c-8.6 0-16.6-4.6-20.9-12.1s-4.2-16.7 .2-24.1l52.5-88.5c13-21.9 36.5-35.3 61.9-35.3l82.3 0c2.4-4 4.8-7.7 7.2-11.3C289.1-4.1 411.1-8.1 483.9 5.3c11.6 2.1 20.6 11.2 22.8 22.8c13.4 72.9 9.3 194.8-111.4 276.7c-3.5 2.4-7.3 4.8-11.3 7.2l0 82.3c0 25.4-13.4 49-35.3 61.9l-88.5 52.5c-7.4 4.4-16.6 4.5-24.1 .2s-12.1-12.2-12.1-20.9l0-107.2c-14.1 4.9-26.4 8.9-35.7 11.9c-11.2 3.6-23.4 .5-31.8-7.8zM384 168a40 40 0 1 0 0-80 40 40 0 1 0 0 80z', $elm$core$Maybe$Nothing));
var $lattyware$elm_fontawesome$FontAwesome$Solid$rocket = $lattyware$elm_fontawesome$FontAwesome$present($lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$rocket);
...
var $author$project$Components$UaDropdown$withDefault = F2(
	function (item, s) {
		var items = s.items;
		return A2($elm$core$List$member, item, items) ? _Utils_update(
			s,
			{
				selected: $elm$core$Maybe$Just(item)
			}) : s;
	});
var $author$project$Components$UaDropdown$select = $author$project$Components$UaDropdown$withDefault;
...
var $author$project$Components$UaDropdown$toggle = F2(
	function (on, st) {
		return _Utils_update(
			st,
			{isOpen: on});
...
var $author$project$Components$Dropdown$drawer = F4(
	function (_v0, element, givenAttributes, children) {
		...
		var attributes = isToggled ? A2(
			$elm$core$List$cons,
			drawerVisibleAttribute,
			_Utils_ap(
				_List_fromArray(
					[
						A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'visibility', 'visible'),
						A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'position', 'absolute')
					]),
				givenAttributes)) : _Utils_ap(
			_List_fromArray(
				[
...
var $author$project$Components$Dropdown$isChildOfSelf = function (cfg) {
	...
	while (true) {
		if (cfg.isDropdown) {
			...
			var _v0 = cfg.parentElement;
			if (_v0.$ === 'Nothing') {
				return $elm$json$Json$Decode$succeed(false);
			} else {
				var domElement = _v0.a.a;
				var $temp$cfg = domElement;
				cfg = $temp$cfg;
				continue isChildOfSelf;
			}
		}
	}
};
	...
	function (_v0, element, attributes, children) {
				...
				A2(
					...
					A2(
						...
						A2(
							...
							$elm$core$Basics$and(isToggled)),
						$elm$core$Basics$not),
					$elm$core$Basics$eq(27)),
		...
		var toggleEvents = function () {
			if (toggleEvent.$ === 'OnHover') {
				return _List_fromArray(
					[
						A2($rtfeldman$elm_css$Html$Styled$Events$on, 'mouseout', handleFocusChanged),
						A2($rtfeldman$elm_css$Html$Styled$Events$on, 'focusout', handleFocusChanged)
					]);
			} else {
				return _List_fromArray(
					[
		...
		return A2(
			...
			_Utils_ap(
				_List_fromArray(
					[
						A2($rtfeldman$elm_css$Html$Styled$Events$on, 'keydown', handleKeyDown)
					]),
				_Utils_ap(
					toggleEvents,
					_Utils_ap(
						_List_fromArray(
							[
								...
								A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'outline', 'none')
							]),
						attributes))),
			children);
	});
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pr_7 = A2($rtfeldman$elm_css$Css$property, 'padding-right', '1.75rem');
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$top_1 = A2($rtfeldman$elm_css$Css$property, 'top', '0.25rem');
...
var $author$project$Components$UaDropdown$dropdownItem = F4(
	function (render, fSelect, selected, obj) {
		return A2(
				...
				[
						...
						[
							...
							_List_fromArray(
								[
									...
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$box_border,
									A2($rtfeldman$elm_css$Css$property, 'width', 'max-content'),
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pl_3,
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pr_7,
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$py_1,
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$whitespace_nowrap,
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$overflow_hidden,
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_ellipsis
								]))
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$absolute, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$top_1, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$right_2]))
						]),
					_List_fromArray(
						[
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$left_auto = A2($rtfeldman$elm_css$Css$property, 'left', 'auto');
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$right_0 = A2($rtfeldman$elm_css$Css$property, 'right', '0px');
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$right_auto = A2($rtfeldman$elm_css$Css$property, 'right', 'auto');
var $author$project$TwUtil$fix_left_right = function (align) {
	return _Utils_eq(align, $author$project$TwUtil$Left) ? _List_fromArray(
...
var $author$project$Components$UaDropdown$dropdownMenu = F6(
	function (toDrawer, align, render, fSelect, items, selected) {
		return A3(
			toDrawer,
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					...
					_Utils_ap(
						...
						_Utils_ap(
							$author$project$TwUtil$border,
							$author$project$TwUtil$fix_left_right(align))))
				]),
			A2(
				$elm$core$List$map,
				A3($author$project$Components$UaDropdown$dropdownItem, render, fSelect, selected),
				items));
	});
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_2 = A2($rtfeldman$elm_css$Css$property, 'padding', '0.5rem');
var $author$project$Components$UaDropdown$dropdownToggle = F2(
	function (toToggle, children) {
		return A3(
			toToggle,
			$rtfeldman$elm_css$Html$Styled$button,
			_List_fromArray(
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$items_center,
								A2($rtfeldman$elm_css$Css$property, 'width', 'max-content'),
								A2($rtfeldman$elm_css$Css$property, 'min-width', '2.5rem'),
								$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$h_10,
...
var $author$project$Components$UaDropdown$view = F2(
	function (_v0, _v1) {
		var identifier = _v0.identifier;
		var render = _v0.render;
		var onSelect = _v0.onSelect;
		var onToggle = _v0.onToggle;
		var showSelectedInTopLevel = _v0.showSelectedInTopLevel;
		var icon = _v0.icon;
		var align = _v0.align;
		var items = _v1.items;
		var selected = _v1.selected;
		var hint = _v1.hint;
		var isOpen = _v1.isOpen;
		return $author$project$Components$Dropdown$dropdown(
			{
				drawerVisibleAttribute: $rtfeldman$elm_css$Html$Styled$Attributes$class(''),
				identifier: identifier,
				isToggled: isOpen,
				layout: function (_v2) {
					var toDropdown = _v2.toDropdown;
					var toToggle = _v2.toToggle;
					var toDrawer = _v2.toDrawer;
					return A3(
						toDropdown,
						$rtfeldman$elm_css$Html$Styled$div,
						_List_Nil,
						_List_fromArray(
							[
								A2(
								$author$project$Components$UaDropdown$dropdownToggle,
								toToggle,
								A3(
									$author$project$Util$appendIfT,
									showSelectedInTopLevel,
									_List_fromArray(
										[
											A2(
											$rtfeldman$elm_css$Html$Styled$span,
											_List_fromArray(
												[
													$rtfeldman$elm_css$Html$Styled$Attributes$css(
													_List_fromArray(
														[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$ml_2, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_lg]))
												]),
											_List_fromArray(
												[
													function () {
													if (selected.$ === 'Just') {
														...
														return $rtfeldman$elm_css$Html$Styled$text(hint);
													}
												}()
												]))
										]),
								...
								A6($author$project$Components$UaDropdown$dropdownMenu, toDrawer, align, render, onSelect, items, selected)
							]));
				},
				onToggle: onToggle,
...
var $author$project$Components$UaTable$generateUaContainer = F2(
	function (xs, toolbarState) {
		var resetLastAction = function (generateConfigState) {
			return _Utils_update(
				generateConfigState,
				{generateLastAction: false});
		};
		var pipe = function (fUpdateState) {
			return A3(
				$author$project$Components$UaTable$mkPipe,
				$author$project$Components$UaTable$UpdateToolbarState,
				toolbarState,
				function (s) {
					var generateConfigState = s.generateConfigState;
					return _Utils_update(
						s,
						{
							generateConfigState: fUpdateState(generateConfigState)
						});
				});
		};
		return (!toolbarState.generateConfigState.showGenerateContainer) ? A2($rtfeldman$elm_css$Html$Styled$div, _List_Nil, _List_Nil) : A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_Utils_ap(
						_List_fromArray(
							[
								...
								$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$gap_2,
								...
								$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_t,
								$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_t_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$gray_300)
							]),
						xs))
				]),
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$css(
							_List_fromArray(
								[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$flex, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$flex_wrap, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$justify_start, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$gap_2]))
						]),
					A3(
						$author$project$Util$appendIfT,
						_Utils_eq(
							toolbarState.generateConfigState.ddPreset.selected,
							$elm$core$Maybe$Just('Custom')),
						_List_fromArray(
							[
								A2(
								$author$project$Components$UaDropdown$view,
								{
									align: $author$project$TwUtil$Left,
									icon: $author$project$TwUtil$icon($lattyware$elm_fontawesome$FontAwesome$Solid$globe),
									...
									onSelect: function (item) {
										return pipe(
											A2(
												...
												resetLastAction,
												function (gstate) {
													var ddBrowser = gstate.ddBrowser;
													return _Utils_update(
														gstate,
														{
															ddBrowser: A2($author$project$Components$UaDropdown$select, item, ddBrowser)
														});
												}));
									},
										...
										return pipe(
											function (gstate) {
												...
												return _Utils_update(
													gstate,
													{
														ddBrowser: A2($author$project$Components$UaDropdown$toggle, on, ddBrowser)
													});
											});
									},
									render: $rtfeldman$elm_css$Html$Styled$text,
								...
								{
									align: $author$project$TwUtil$Left,
									icon: $author$project$TwUtil$icon($lattyware$elm_fontawesome$FontAwesome$Solid$mobile),
									...
									onSelect: function (item) {
										return pipe(
											A2(
												...
												resetLastAction,
												function (gstate) {
													var ddOsDevice = gstate.ddOsDevice;
													return _Utils_update(
														gstate,
														{
															ddOsDevice: A2($author$project$Components$UaDropdown$select, item, ddOsDevice)
														});
												}));
									},
									onToggle: function (on) {
										return pipe(
											function (gstate) {
												...
												return _Utils_update(
													gstate,
													{
														ddOsDevice: A2($author$project$Components$UaDropdown$toggle, on, ddOsDevice)
													});
											});
									},
									render: $rtfeldman$elm_css$Html$Styled$text,
						...
						_List_fromArray(
							[
								...
								{
									align: $author$project$TwUtil$Left,
									icon: $author$project$TwUtil$icon($lattyware$elm_fontawesome$FontAwesome$Solid$rocket),
									...
									onSelect: function (item) {
										return pipe(
											A2(
												...
												resetLastAction,
												function (gstate) {
													var ddPreset = gstate.ddPreset;
													return _Utils_update(
														gstate,
														{
															ddPreset: A2($author$project$Components$UaDropdown$select, item, ddPreset)
														});
												}));
									},
									onToggle: function (on) {
										return pipe(
											function (gstate) {
												...
												return _Utils_update(
													gstate,
													{
														ddPreset: A2($author$project$Components$UaDropdown$toggle, on, ddPreset)
													});
											});
									},
									render: $rtfeldman$elm_css$Html$Styled$text,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Components$UaTable$OnGenerateClicked),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_Utils_ap(
										_List_fromArray(
											[
									...
									_Utils_eq(toolbarState.generateConfigState.ddPreset.selected, $elm$core$Maybe$Nothing))
								]),
							_List_fromArray(
								[
									$author$project$TwUtil$icon(
									A3($author$project$Util$iff, toolbarState.generateConfigState.generateLastAction, $lattyware$elm_fontawesome$FontAwesome$Solid$arrowsRotate, $lattyware$elm_fontawesome$FontAwesome$Solid$arrowRight)),
									A2(
									$rtfeldman$elm_css$Html$Styled$span,
									_List_fromArray(
										[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text('Generate Agents')
										]))
								]))
						]))
				]));
...
var $author$project$Components$Internal$State$getItemsPerPage = function (state) {
	return A2(
		$elm$core$Maybe$withDefault,
		0,
		$elm$core$String$toInt(
			A2($elm$core$Maybe$withDefault, '', state.ddPagination.selected)));
};
...
var $author$project$Components$Internal$Table$filterRows = F3(
	function (config, state, rows) {
		var cfg = config.a;
		var ipp = $author$project$Components$Internal$State$getItemsPerPage(state);
		...
		var srows = A3(
			$author$project$Components$Internal$Util$iff,
			_Utils_eq(cfg.type_, $author$project$Components$Table$Types$Static),
			A3($author$project$Components$Internal$Table$sort, cfg.table.columns, state, frows),
			frows);
		var cut = F3(
			function (rs, pg, count) {
		...
		var prows = A3(
			$author$project$Components$Internal$Util$iff,
			_Utils_eq(cfg.type_, $author$project$Components$Table$Types$Static) && ((!_Utils_eq(cfg.pagination, $author$project$Components$Internal$Config$None)) && (!(!ipp))),
			A3(cut, srows, state.page, ipp),
			srows);
		return prows;
	});
var $author$project$Components$Internal$Table$getFiltered = F2(
	function (config, _v0) {
		...
		if (rows.a.$ === 'Loaded') {
			...
			return A2(
				...
				A3($author$project$Components$Internal$Table$filterRows, config, state, lrows.rows));
		} else {
			return _List_Nil;
		}
	});
var $author$project$Components$Table$Table$getFiltered = $author$project$Components$Internal$Table$getFiltered;
		...
		return $author$project$Components$Internal$Config$Config(
			{
				...
				onRowClick: $elm$core$Maybe$Nothing,
				...
				toolbar: _List_Nil,
				toolbarContainer: _List_Nil,
				type_: $author$project$Components$Table$Types$Static
			});
	});
var $author$project$Components$Table$Table$static = $author$project$Components$Internal$Config$static;
		...
		return _List_fromArray(
			[
				...
				A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text(col.name)
						])),
				A2(
					$rtfeldman$elm_css$Html$Styled$abbr,
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$title(col.name)
						]),
					_List_fromArray(
						[
				...
				A3(
					...
					A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$class('sort'),
								$rtfeldman$elm_css$Html$Styled$Events$onClick(
								pipe(
									function (s) {
										return _Utils_update(
		...
		return $author$project$Components$Internal$Column$Column(
			{
				...
				_default: true,
				hiddable: true,
				lineClamp: $elm$core$Maybe$Nothing,
				name: name,
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$diceThree = A4(
	$lattyware$elm_fontawesome$FontAwesome$IconDef,
	'fas',
	'dice-three',
	_Utils_Tuple2(448, 512),
	_Utils_Tuple2('M64 32C28.7 32 0 60.7 0 96L0 416c0 35.3 28.7 64 64 64l320 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64L64 32zm64 96a32 32 0 1 1 0 64 32 32 0 1 1 0-64zm64 128a32 32 0 1 1 64 0 32 32 0 1 1 -64 0zm128 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64z', $elm$core$Maybe$Nothing));
var $lattyware$elm_fontawesome$FontAwesome$Solid$diceThree = $lattyware$elm_fontawesome$FontAwesome$present($lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$diceThree);
var $author$project$Components$UaTable$toggleGenerateContainerButton = function (toolbarState) {
	var pipe = function (fUpdateState) {
		return A3(
			$author$project$Components$UaTable$mkPipe,
			$author$project$Components$UaTable$UpdateToolbarState,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				pipe(
					function (s) {
						var showGenerateContainer = s.showGenerateContainer;
						return _Utils_update(
							s,
							{showGenerateContainer: !showGenerateContainer});
					})),
				$rtfeldman$elm_css$Html$Styled$Attributes$css(
				_Utils_ap(
					_List_fromArray(
		...
		_List_fromArray(
			[
				$author$project$TwUtil$icon($lattyware$elm_fontawesome$FontAwesome$Solid$diceThree)
			]));
};
var $author$project$Components$Internal$Column$withCss = F2(
	function (css, _v0) {
		var col = _v0.a;
		return $author$project$Components$Internal$Column$Column(
			_Utils_update(
...
var $author$project$Components$Table$Column$withCss = $author$project$Components$Internal$Column$withCss;
var $author$project$Components$Internal$Column$withDefault = F2(
	function (value, _v0) {
		var col = _v0.a;
		return $author$project$Components$Internal$Column$Column(
			_Utils_update(
...
var $author$project$Components$Table$Column$withDefault = $author$project$Components$Internal$Column$withDefault;
var $author$project$Components$Internal$Column$withLineClamp = F2(
	function (clamp, _v0) {
		var col = _v0.a;
		return $author$project$Components$Internal$Column$Column(
			_Utils_update(
...
var $author$project$Components$Table$Column$withLineClamp = $author$project$Components$Internal$Column$withLineClamp;
var $author$project$Components$Internal$Config$withRowClickHandler = F2(
	function (h, _v0) {
		var c = _v0.a;
		return $author$project$Components$Internal$Config$Config(
			_Utils_update(
				c,
				{
					onRowClick: $elm$core$Maybe$Just(h)
				}));
	});
var $author$project$Components$Table$Config$withRowClickHandler = $author$project$Components$Internal$Config$withRowClickHandler;
var $author$project$Components$Internal$Config$Limit = function (a) {
	return {$: 'Limit', a: a};
};
var $author$project$Components$Internal$Config$withRowLimits = F3(
	function (capabilities, initial, _v0) {
		...
		return $author$project$Components$Internal$Config$Config(
			_Utils_update(
				c,
				{
					pagination: $author$project$Components$Internal$Config$Limit(
						{capabilities: capabilities, initial: initial})
				}));
	});
var $author$project$Components$Table$Config$withRowLimits = $author$project$Components$Internal$Config$withRowLimits;
var $author$project$Components$Internal$Config$withStickyHeader = function (_v0) {
	var c = _v0.a;
	return $author$project$Components$Internal$Config$Config(
		_Utils_update(
			c,
...
var $author$project$Components$Table$Config$withStickyHeader = $author$project$Components$Internal$Config$withStickyHeader;
...
var $author$project$Components$Internal$Config$withToolbarContainer = F2(
	function (t, _v0) {
		var c = _v0.a;
		return $author$project$Components$Internal$Config$Config(
			_Utils_update(
...
var $author$project$Components$Table$Config$withToolbarContainer = $author$project$Components$Internal$Config$withToolbarContainer;
var $author$project$Components$UaTable$config = function (smallScreen) {
	return A2(
		$author$project$Components$Table$Config$withToolbarContainer,
		_List_fromArray(
			[$author$project$Components$UaTable$generateUaContainer]),
		A2(
			$author$project$Components$Table$Config$withToolbar,
			_List_fromArray(
				[
					$author$project$Components$UaTable$fetchUaButton,
					$author$project$Components$UaTable$toggleGenerateContainerButton,
					$author$project$Components$UaTable$copyAllButton(smallScreen)
				]),
			A3(
				$author$project$Components$Table$Config$withRowLimits,
				_List_fromArray(
					['10', '20', '50', 'All']),
				'All',
				A2(
					$author$project$Components$Table$Config$withRowClickHandler,
					$author$project$Components$UaTable$OnRowClick,
					$author$project$Components$Table$Config$withStickyHeader(
						A3(
							$author$project$Components$Table$Table$static,
							...
							_List_fromArray(
								[
									A2(
									$author$project$Components$Table$Column$withLineClamp,
									$elm$core$Maybe$Just(3),
									A2(
										$author$project$Components$Table$Column$withCss,
										_List_fromArray(
											[
										...
										A3(
											...
											''))),
									A3(
									$author$project$Util$applyIfT,
									smallScreen,
									$author$project$Components$Table$Column$withDefault(false),
									A3(
										$author$project$Components$Table$Column$string,
										function ($) {
											return $.browserName;
...
var $author$project$Components$UaTable$copyAllButton = F2(
	function (smallScreen, _v0) {
		var copyAllState = _v0.copyAllState;
		return A2(
			$rtfeldman$elm_css$Html$Styled$button,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Events$onClick(
					$author$project$Components$UaTable$ClipboardMsg(
						$author$project$Components$Clipboard$CopyAction(
							A2(
								$elm$core$Basics$composeL,
								A2(
									$elm$core$Basics$composeL,
								...
								$author$project$Components$Table$Table$getFiltered(
									$author$project$Components$UaTable$config(smallScreen)))))),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_Utils_ap(
						_List_fromArray(
							[
			...
			_List_fromArray(
				[
					$author$project$TwUtil$icon(
					A3(
						$author$project$Util$iff,
						_Utils_eq(copyAllState, $author$project$Components$Clipboard$Idle),
						$lattyware$elm_fontawesome$FontAwesome$Solid$clipboardList,
						$lattyware$elm_fontawesome$FontAwesome$Solid$clipboardCheck))
				]));
	});
...
var $author$project$Components$Table$Types$Status = function (a) {
	return {$: 'Status', a: a};
};
...
var $author$project$Components$UaDropdown$init = function (items) {
	return {hint: '', isOpen: false, items: items, selected: $elm$core$Maybe$Nothing};
};
...
var $author$project$Components$Internal$Table$init = function (_v0) {
	...
	var visibleColumns = A2($elm$core$List$filterMap, fnVisible, cfg.table.columns);
	var visibleSubColumns = A2(
		$elm$core$Maybe$withDefault,
		_List_Nil,
		A2(
			$elm$core$Maybe$map,
	...
	var _v1 = function () {
		...
		switch (_v2.$) {
			case 'ByPage':
				...
				return _Utils_Tuple2(
					A2($elm$core$List$map, $elm$core$String$fromInt, capabilities),
					$elm$core$String$fromInt(initial));
			case 'Limit':
				var capabilities = _v2.a.capabilities;
				var initial = _v2.a.initial;
				return _Utils_Tuple2(capabilities, initial);
			default:
				return _Utils_Tuple2(_List_Nil, '');
		}
	}();
	var ddPaginationOptions = _v1.a;
	var ddPaginationInitial = _v1.b;
	var _v3 = $elm$core$List$unzip(
		A2($elm$core$List$map, fnNameSelected, cfg.table.columns));
	var colNames = _v3.a;
	var colSelecteds = _v3.b;
	return $author$project$Components$Internal$Data$Model(
		{
			rows: $author$project$Components$Internal$Data$Rows(
				$author$project$Components$Table$Types$Status('')),
			state: {
				ddColumns: A2($author$project$Components$UaDropdownMultiSelect$init2, colNames, colSelecteds),
				ddPagination: A2(
					$author$project$Components$UaDropdown$withDefault,
					ddPaginationInitial,
					$author$project$Components$UaDropdown$init(ddPaginationOptions)),
...
var $author$project$Components$Table$Table$init = $author$project$Components$Internal$Table$init;
var $author$project$Components$UaDropdown$withHint = F2(
	function (hint, s) {
		return _Utils_update(
			s,
			{hint: hint});
	});
var $author$project$Components$Internal$Data$withStatus = F2(
	function (msg, _v0) {
		var model = _v0.a;
		return $author$project$Components$Internal$Data$Model(
			_Utils_update(
				...
				{
					rows: $author$project$Components$Internal$Data$Rows(
						$author$project$Components$Table$Types$Status(msg))
				}));
	});
var $author$project$Components$Table$Table$withStatus = $author$project$Components$Internal$Data$withStatus;
var $author$project$Components$UaTable$init = function (width) {
	var smallScreen = width < 640;
	return {
		smallScreen: smallScreen,
		table: A2(
			$author$project$Components$Table$Table$withStatus,
			'Load / Generate Data',
			$author$project$Components$Table$Table$init(
				$author$project$Components$UaTable$config(smallScreen))),
		toolbarState: {
			copyAllState: $author$project$Components$Clipboard$Idle,
			generateConfigState: {
				ddBrowser: A2(
					$author$project$Components$UaDropdown$withDefault,
					'Any',
					$author$project$Components$UaDropdown$init(
						_List_fromArray(
							['Any', 'Chrome', 'Firefox']))),
				ddOsDevice: A2(
					$author$project$Components$UaDropdown$withDefault,
					...
					$author$project$Components$UaDropdown$init(
						_List_fromArray(
							['Any', 'Linux', 'Windows', 'macOS', 'iOS', 'Android']))),
				ddPreset: A2(
					$author$project$Components$UaDropdown$withHint,
					'Select Preset',
					$author$project$Components$UaDropdown$init(
						_List_fromArray(
							['Spray & Pray', 'Browsers', 'Mobile', 'Devices', 'Tools', 'Uncommon', 'Custom']))),
				generateLastAction: false,
...
var $author$project$View$init = function (flags) {
	var _v0 = function () {
		var _v1 = A2($elm$json$Json$Decode$decodeString, $author$project$View$flagDecoder, flags);
		if (_v1.$ === 'Ok') {
			var res = _v1.a;
			return res;
		} else {
			var e = _v1.a;
			var _v2 = A2($elm$core$Debug$log, 'error (unable to decode flags)', e);
			return {width: 1024};
		}
	}();
	var width = _v0.width;
	return _Utils_Tuple2(
		{
			...
			tableModel: $author$project$Components$UaTable$init(width)
		},
...
var $author$project$Components$UaTable$ClipboardRowMsg = function (a) {
	return {$: 'ClipboardRowMsg', a: a};
};
var $author$project$Components$Clipboard$CopyStatus = function (a) {
	return {$: 'CopyStatus', a: a};
};
var $author$project$Components$UaTable$RecvUserAgentBatch = function (a) {
	return {$: 'RecvUserAgentBatch', a: a};
};
var $elm$json$Json$Decode$bool = _Json_decodeBool;
var $author$project$Components$UaTable$recvCopyAllStatus = _Platform_incomingPort('recvCopyAllStatus', $elm$json$Json$Decode$bool);
var $author$project$Components$UaTable$recvCopyRowStatus = _Platform_incomingPort('recvCopyRowStatus', $elm$json$Json$Decode$bool);
...
var $author$project$Components$Table$Table$subscriptions = $author$project$Components$Internal$Subscription$subscriptions;
var $author$project$Components$UaTable$subscriptions = function (model) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(
				$author$project$Components$Table$Table$subscriptions,
				$author$project$Components$UaTable$config(model.smallScreen),
				model.table),
				$author$project$Components$UaTable$recvUserAgentBatch($author$project$Components$UaTable$RecvUserAgentBatch),
				$author$project$Components$UaTable$recvCopyAllStatus(
				A2($elm$core$Basics$composeL, $author$project$Components$UaTable$ClipboardMsg, $author$project$Components$Clipboard$CopyStatus)),
				$author$project$Components$UaTable$recvCopyRowStatus(
				A2($elm$core$Basics$composeL, $author$project$Components$UaTable$ClipboardRowMsg, $author$project$Components$Clipboard$CopyStatus))
			]));
};
...
var $author$project$Components$UaTable$OnFetchUserAgentsCompleted = function (a) {
	return {$: 'OnFetchUserAgentsCompleted', a: a};
};
	...
	switch (error.$) {
		...
		case 'BadStatus':
			switch (error.a) {
				...
				default:
					var s = error.a;
					return 'Unknown error: status code ' + $elm$core$String$fromInt(s);
			}
		default:
...
var $author$project$Components$Table$Types$Failed = function (a) {
	return {$: 'Failed', a: a};
};
var $author$project$Components$Internal$Data$failed = F2(
	function (_v0, msg) {
		var model = _v0.a;
		return $author$project$Components$Internal$Data$Model(
			_Utils_update(
				...
				{
					rows: $author$project$Components$Internal$Data$Rows(
						$author$project$Components$Table$Types$Failed(msg))
				}));
	});
var $author$project$Components$Table$Table$failed = $author$project$Components$Internal$Data$failed;
...
var $author$project$Components$Table$Table$getItemsPerPage = function (_v0) {
	var state = _v0.a.state;
	return $author$project$Components$Internal$State$getItemsPerPage(state);
};
var $author$project$Util$if0then = F2(
	function (_default, test) {
		return (!test) ? _default : test;
	});
...
var $author$project$Components$UaTable$jsAnalyseUserAgentBatch = _Platform_outgoingPort(
	'jsAnalyseUserAgentBatch',
...
var $author$project$Components$UaTable$jsGenerateUserAgents = _Platform_outgoingPort(
	'jsGenerateUserAgents',
	function ($) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'osDevice',
					$elm$json$Json$Encode$string($.osDevice)),
					_Utils_Tuple2(
					'preset',
					$elm$json$Json$Encode$string($.preset))
				]));
	});
...
var $author$project$Components$Table$Table$loadedStatic = F2(
	function (rows, model) {
		return A3(
			$author$project$Components$Internal$Data$loaded,
			model,
			rows,
			$elm$core$List$length(rows));
	});
var $author$project$Components$UaTable$setRowsToModel = F2(
	function (x, model) {
		if (x.$ === 'Ok') {
			var rows = x.a;
			return _Utils_update(
				model,
				{
					table: A2($author$project$Components$Table$Table$loadedStatic, rows, model.table)
				});
		} else {
			var err = x.a;
...
var $author$project$Components$UaTable$uaDataFile = 'data.txt';
...
var $author$project$Components$Clipboard$Copied = {$: 'Copied'};
var $author$project$Components$Clipboard$CopiedTimeout = {$: 'CopiedTimeout'};
...
var $author$project$Components$Clipboard$copyToClipboard = _Platform_outgoingPort(
	'copyToClipboard',
	function ($) {
		var a = $.a;
		var b = $.b;
...
var $author$project$Components$Clipboard$update = F4(
	function (port_, m, model, vs) {
		switch (m.$) {
			case 'CopyAction':
				var func = m.a;
				var str = func(model);
				return _Utils_Tuple2(
					vs,
					$author$project$Components$Clipboard$copyToClipboard(
						_Utils_Tuple2(port_, str)));
			case 'CopyStatus':
				var ok = m.a;
				return ok ? _Utils_Tuple2(
					$author$project$Components$Clipboard$Copied,
					A2(
						$elm$core$Task$attempt,
						function (_v1) {
							return $author$project$Components$Clipboard$CopiedTimeout;
						},
						$elm$core$Process$sleep(5000))) : _Utils_Tuple2(vs, $elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2($author$project$Components$Clipboard$Idle, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Components$UaTable$withToolbarState = F2(
	function (st, m) {
		return _Utils_update(
			m,
			{toolbarState: st});
...
var $author$project$Components$UaTable$update = F2(
	function (msg, model) {
		var toolbarState = model.toolbarState;
		switch (msg.$) {
			case 'OnTable':
				var m = msg.a;
				return _Utils_Tuple2(
			...
			case 'OnRowClick':
				var rec = msg.a;
				var _v1 = A4(
					$author$project$Components$Clipboard$update,
					'recvCopyRowStatus',
					$author$project$Components$Clipboard$CopyAction(
						function ($) {
							return $.ua;
					...
					rec,
					$author$project$Components$Clipboard$Idle);
				var cmd = _v1.b;
				return _Utils_Tuple2(
					model,
					A2($elm$core$Platform$Cmd$map, $author$project$Components$UaTable$ClipboardRowMsg, cmd));
			case 'RecvUserAgentBatch':
				var val = msg.a;
				var decoded = A2(
					...
					val);
				return _Utils_Tuple2(
					A2($author$project$Components$UaTable$setRowsToModel, decoded, model),
					$elm$core$Platform$Cmd$none);
			case 'OnFetchUserAgentsClicked':
				return _Utils_Tuple2(
					model,
					$elm$http$Http$get(
						{
							expect: $elm$http$Http$expectString($author$project$Components$UaTable$OnFetchUserAgentsCompleted),
							url: $author$project$Components$UaTable$uaDataFile
						}));
			case 'OnFetchUserAgentsCompleted':
				if (msg.a.$ === 'Ok') {
					var res = msg.a.a;
					var lines = A2($elm$core$String$split, '\n', res);
					return _Utils_Tuple2(
						model,
						$author$project$Components$UaTable$jsAnalyseUserAgentBatch(lines));
				} else {
					var e = msg.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								table: A2(
									$author$project$Components$Table$Table$failed,
									model.table,
			...
			case 'OnGenerateClicked':
				var st = model.toolbarState.generateConfigState;
				var payload = {
					browser: A2($elm$core$Maybe$withDefault, '', st.ddBrowser.selected),
					count: A2(
						$author$project$Util$if0then,
						10,
						$author$project$Components$Table$Table$getItemsPerPage(model.table)),
					osDevice: A2($elm$core$Maybe$withDefault, '', st.ddOsDevice.selected),
					preset: A2($elm$core$Maybe$withDefault, '', st.ddPreset.selected)
				};
				return _Utils_Tuple2(
					A2(
						$author$project$Components$UaTable$withToolbarState,
						_Utils_update(
							toolbarState,
							{
								generateConfigState: _Utils_update(
									st,
									{generateLastAction: true})
							}),
						model),
					$author$project$Components$UaTable$jsGenerateUserAgents(payload));
			case 'ClipboardMsg':
				var m = msg.a;
				var _v2 = A4($author$project$Components$Clipboard$update, 'recvCopyAllStatus', m, model.table, model.toolbarState.copyAllState);
				var state = _v2.a;
				var cmd = _v2.b;
				var _v3 = A2($elm$core$Debug$log, 'called', 'ClipboardMsg');
				return _Utils_Tuple2(
					A2(
						$author$project$Components$UaTable$withToolbarState,
						_Utils_update(
							...
							{copyAllState: state}),
						model),
					A2($elm$core$Platform$Cmd$map, $author$project$Components$UaTable$ClipboardMsg, cmd));
			default:
				var _v4 = A2($elm$core$Debug$log, 'called', 'ClipboardRowMsg');
			...
			if (msg.a.$ === 'Browser') {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							filterBrowser: A2($elm$core$Debug$log, 'log: ', s)
						}),
					$elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_collapse = A2($rtfeldman$elm_css$Css$property, 'border-collapse', 'collapse');
	...
	function (lens, getID, v, _v0) {
		...
		var updatedExpand = A3(
			...
			A2(
				...
				conf.expanded),
			A2($elm$core$List$cons, id, conf.expanded));
		return _List_fromArray(
			[
				A2(
				$rtfeldman$elm_css$Html$Styled$a,
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$class('btn-expand'),
						$rtfeldman$elm_css$Html$Styled$Events$onClick(
						pipe(
							function (s) {
								return A2(
		...
		return $author$project$Components$Internal$Column$Column(
			{
				...
				lineClamp: $elm$core$Maybe$Nothing,
				name: '',
				searchable: $elm$core$Maybe$Nothing,
				sortable: $elm$core$Maybe$Nothing,
				viewCell: F2(
					function (v, _v0) {
						var s = _v0.a;
						return A4(
	...
	function (_v0, _v1, value, state, check) {
		...
		var updatedSelected = A3(
			...
			A2(
				...
				$elm$core$Basics$neq(id),
				selected));
		var _v2 = _Utils_Tuple2(cfg.selection, cfg.subtable);
		_v2$5:
		while (true) {
			switch (_v2.a.$) {
				case 'Disable':
	...
	function (config, rows, value, _v0) {
		...
		return _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$class('checkbox'),
	...
	function (_v0, rows, state, check) {
		...
		var selected = A3(
			...
			A2(
				...
				function (_v8) {
					var a = _v8.a;
					return cfg.table.getID(a);
				},
				rows),
			_List_Nil);
		var _v1 = _Utils_Tuple2(cfg.selection, cfg.subtable);
		_v1$3:
		while (true) {
			if (_v1.b.$ === 'Just') {
				switch (_v1.a.$) {
		...
		if (isDisable(v)) {
			return _List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$class('btn-subtable is-disabled'),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$class('gg-plus')
								]),
							_List_Nil)
						]))
				]);
			...
			var updatedExpand = A3(
				...
				A2(
					...
					$elm$core$Basics$neq(id),
					conf.subtable),
				A2($elm$core$List$cons, id, conf.subtable));
			return _List_fromArray(
				[
					A2(
					$rtfeldman$elm_css$Html$Styled$a,
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$class('btn-subtable'),
							$rtfeldman$elm_css$Html$Styled$Events$onClick(
							pipe(
								function (s) {
									return A2(
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_b = A2($rtfeldman$elm_css$Css$property, 'border-bottom-width', '1px');
		...
		switch (_v2.$) {
			...
			case 'ExclusiveStrict':
				...
				var ss = A2(
					$elm$core$List$filter,
					function (x) {
						return A2($elm$core$List$member, x, rs);
					},
					selected);
				return A2(
					$author$project$Components$Internal$Selection$lensSubTableSelected.set,
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Theme$gray_50 = A5($matheus23$elm_tailwind_modules_base$Tailwind$Color$Color, 'rgb', '249', '250', '251', $matheus23$elm_tailwind_modules_base$Tailwind$Color$ViaVariable);
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_2,
											$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_b,
											$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$gray_300)
										])),
									$rtfeldman$elm_css$Html$Styled$Attributes$class(c._class),
									A2($rtfeldman$elm_css$Html$Styled$Attributes$style, 'width', c.width)
								]),
							A2(
								c.viewCell,
								r,
								_Utils_Tuple2(state, pipeExt)));
					},
					columns)),
				function () {
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_2,
												$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$gray_50)
											])),
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$sticky = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2($rtfeldman$elm_css$Css$property, 'position', '-webkit-sticky'),
			A2($rtfeldman$elm_css$Css$property, 'position', 'sticky')
		]));
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$top_16 = A2($rtfeldman$elm_css$Css$property, 'top', '4rem');
...
var $author$project$Components$Internal$Table$tableContentHead = F6(
	function (stickyHeader, hasSelection, pipeExt, pipeInt, columns, state) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$thead,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					stickyHeader ? _List_fromArray(
						[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$sticky, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$top_16]) : _List_Nil)
				]),
			_List_fromArray(
				[
					A2(
							...
							function (i, col) {
								...
								return A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$uppercase,
									...
									A2(
										...
										_Utils_Tuple2(
											state,
											((!i) && hasSelection) ? pipeInt : pipeExt)));
							}),
						columns))
				]));
	});
var $author$project$Components$Internal$Table$subtableContent = F7(
	function (config, pipeExt, pipeInt, parent, subConfig, state, data) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$class('subtable-content')
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									A3(
									$author$project$Components$Internal$Util$iff,
									_Utils_eq(cfg.onRowClick, $elm$core$Maybe$Nothing),
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$cursor_default,
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$cursor_pointer),
									$rtfeldman$elm_css$Css$hover(
									_List_fromArray(
										[
										...
										[
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															A2($rtfeldman$elm_css$Css$property, '-webkit-box-orient', 'vertical'),
															A2(
															$rtfeldman$elm_css$Css$property,
															'-webkit-line-clamp',
															$elm$core$String$fromInt(nlines)),
															A2(
															$rtfeldman$elm_css$Css$property,
															'line-clamp',
															$elm$core$String$fromInt(nlines)),
															$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$block,
															A2($rtfeldman$elm_css$Css$property, 'display', '-webkit-box'),
															$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$overflow_hidden,
															$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_ellipsis
														]))
												]),
...
var $author$project$Components$Internal$Table$tableContent = F5(
	function (config, pipeExt, pipeInt, state, rows) {
		...
		var prows = A3($author$project$Components$Internal$Table$filterRows, config, state, rows);
		var expandColumn = A2(
			$author$project$Components$Internal$Util$ifMaybe,
						...
						[
							...
							_List_fromArray(
								[
									...
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$white),
									$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$border_collapse
								]))
						]),
					_List_fromArray(
						[
...
var $author$project$Components$Internal$Pagination$pagIndex = F2(
	function (n, c) {
		if (!c) {
			if (n > 3) {
				var m = $elm$core$Basics$floor(n / 2);
				return _Utils_Tuple3(m - 1, m, m + 1);
			} else {
				return _Utils_Tuple3(0, 1, 2);
			}
		} else {
			if (c === 1) {
				return (n > 3) ? _Utils_Tuple3(1, 2, 3) : _Utils_Tuple3(0, 1, 2);
			} else {
				if (_Utils_eq(c, n - 1)) {
					return (n > 3) ? _Utils_Tuple3(n - 4, n - 3, n - 2) : _Utils_Tuple3(n - 3, n - 2, n - 1);
				} else {
					if (_Utils_eq(c, n - 2)) {
						return _Utils_Tuple3(n - 4, n - 3, n - 2);
					} else {
						return _Utils_Tuple3(c - 1, c, c + 1);
					}
				}
			}
		}
...
var $author$project$Components$Internal$Pagination$paginationEllipsis = A2(
	...
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$class('pagination-ellipsis')
		]),
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$text('…')
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'aria-label',
					'Goto page ' + $elm$core$String$fromInt(i + 1)),
					A2(
					$rtfeldman$elm_css$Html$Styled$Attributes$attribute,
					'aria-current',
					A3(
...
var $author$project$Components$Internal$Pagination$tableFooterContent = F6(
	function (type_, pipeInt, pipeExt, byPage, page, total) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$class('table-footer')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$class('pagination is-centered'),
					...
					_List_fromArray(
						[
							...
							A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Next page')
									]))),
							A2(
							$rtfeldman$elm_css$Html$Styled$ul,
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$class('pagination-list')
								]),
							_List_fromArray(
								[
									A2(
...
var $author$project$Components$Internal$Table$tableFooter = F5(
	function (_v0, pipeExt, pipeInt, state, total) {
		...
		switch (_v1.$) {
			...
			default:
				return A6(
					$author$project$Components$Internal$Pagination$tableFooterContent,
					cfg.type_,
					pipeInt,
					pipeExt,
					$author$project$Components$Internal$State$getItemsPerPage(state),
					state.page,
					total);
		}
	});
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pl_2 = A2($rtfeldman$elm_css$Css$property, 'padding-left', '0.5rem');
...
var $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pr_20 = A2($rtfeldman$elm_css$Css$property, 'padding-right', '5rem');
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_ap(
							_List_fromArray(
								[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$relative, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$inline_flex, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_base, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pl_2, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pr_20, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$w_full, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$h_10]),
							$author$project$TwUtil$border)),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$absolute,
								$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$right_2,
								$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$z_10,
								$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$pointer_events_none,
								$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$gray_300)
							]))
					]),
				_List_fromArray(
					[
							...
							[
								...
								$lattyware$elm_fontawesome$FontAwesome$view(
									A2(
										...
										$lattyware$elm_fontawesome$FontAwesome$Solid$magnifyingGlass)))
							]))
					]))
			]);
	});
...
var $author$project$TwUtil$Right = {$: 'Right'};
var $author$project$Components$UaDropdownMultiSelect$nth = F2(
	function (n, xs) {
		return $elm$core$List$head(
			A2($elm$core$List$drop, n, xs));
	});
var $author$project$Components$UaDropdownMultiSelect$select = F2(
	function (idx, st) {
...
var $author$project$Components$UaDropdownMultiSelect$toggle = F2(
	function (_new, st) {
		return _Utils_update(
			st,
			{isOpen: _new});
				...
				[
					...
					_List_fromArray(
						[
							...
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$box_border,
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$w_full,
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$px_3,
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$py_1,
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$whitespace_nowrap,
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$overflow_hidden,
							$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$text_ellipsis,
...
var $author$project$Components$UaDropdownMultiSelect$dropdownMenu = F5(
	function (toDrawer, align, fSelect, items, selected) {
		return A3(
			toDrawer,
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
			...
			A2(
				$elm$core$List$indexedMap,
				$author$project$Components$UaDropdownMultiSelect$dropdownItem(fSelect),
				A2($author$project$Components$UaDropdownMultiSelect$zip, selected, items)));
	});
var $author$project$Components$UaDropdownMultiSelect$dropdownToggle = F2(
	function (toToggle, icon) {
		return A3(
			toToggle,
			$rtfeldman$elm_css$Html$Styled$button,
			_List_fromArray(
		...
		return $author$project$Components$Dropdown$dropdown(
			{
				...
				layout: function (_v2) {
					...
					return A3(
						...
						_List_fromArray(
							[
								A2($author$project$Components$UaDropdownMultiSelect$dropdownToggle, toToggle, icon),
								A5($author$project$Components$UaDropdownMultiSelect$dropdownMenu, toDrawer, align, onSelect, items, selecteds)
							]));
				},
				onToggle: onToggle,
				toggleEvent: $author$project$Components$Dropdown$OnClick
...
var $author$project$Components$Internal$Toolbar$toolbarMenuColumns = F3(
	function (columns, pipeInt, state) {
		return A2(
			...
			{
				align: $author$project$TwUtil$Right,
				icon: $author$project$TwUtil$icon($lattyware$elm_fontawesome$FontAwesome$Solid$tableColumns),
					...
					return pipeInt(
						function (s) {
							return _Utils_update(
								s,
								{
									ddColumns: A2($author$project$Components$UaDropdownMultiSelect$select, idx, s.ddColumns)
								});
						});
				},
				onToggle: function (on) {
					return pipeInt(
						function (s) {
							return _Utils_update(
								s,
								{
									ddColumns: A2($author$project$Components$UaDropdownMultiSelect$toggle, on, s.ddColumns)
								});
						});
				}
			},
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$hashtag = A4(
	$lattyware$elm_fontawesome$FontAwesome$IconDef,
	'fas',
	'hashtag',
	_Utils_Tuple2(448, 512),
	_Utils_Tuple2('M181.3 32.4c17.4 2.9 29.2 19.4 26.3 36.8L197.8 128l95.1 0 11.5-69.3c2.9-17.4 19.4-29.2 36.8-26.3s29.2 19.4 26.3 36.8L357.8 128l58.2 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-68.9 0L325.8 320l58.2 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-68.9 0-11.5 69.3c-2.9 17.4-19.4 29.2-36.8 26.3s-29.2-19.4-26.3-36.8l9.8-58.7-95.1 0-11.5 69.3c-2.9 17.4-19.4 29.2-36.8 26.3s-29.2-19.4-26.3-36.8L90.2 384 32 384c-17.7 0-32-14.3-32-32s14.3-32 32-32l68.9 0 21.3-128L64 192c-17.7 0-32-14.3-32-32s14.3-32 32-32l68.9 0 11.5-69.3c2.9-17.4 19.4-29.2 36.8-26.3zM187.1 192L165.8 320l95.1 0 21.3-128-95.1 0z', $elm$core$Maybe$Nothing));
var $lattyware$elm_fontawesome$FontAwesome$Solid$hashtag = $lattyware$elm_fontawesome$FontAwesome$present($lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$hashtag);
var $author$project$Components$Internal$Toolbar$toolbarMenuPagination = F3(
	function (pipeExt, pipeInt, state) {
		return A2(
			$author$project$Components$UaDropdown$view,
			{
				align: $author$project$TwUtil$Right,
				icon: $author$project$TwUtil$icon($lattyware$elm_fontawesome$FontAwesome$Solid$hashtag),
					...
					return pipeInt(
						function (s) {
							return _Utils_update(
								s,
								{
									ddPagination: A2($author$project$Components$UaDropdown$select, item, s.ddPagination)
								});
						});
				},
				onToggle: function (on) {
					return pipeInt(
						function (s) {
							return _Utils_update(
								s,
								{
									ddPagination: A2($author$project$Components$UaDropdown$toggle, on, s.ddPagination)
								});
						});
				},
				render: $rtfeldman$elm_css$Html$Styled$text,
					...
					return pipeInt(
						function (s) {
							return _Utils_update(
								s,
								{
									ddSubColumns: A2($author$project$Components$UaDropdownMultiSelect$select, idx, s.ddSubColumns)
								});
						});
				},
				onToggle: function (on) {
					return pipeInt(
						function (s) {
							return _Utils_update(
								s,
								{
									ddSubColumns: A2($author$project$Components$UaDropdownMultiSelect$toggle, on, s.ddSubColumns)
								});
						});
				}
			},
	...
	function (_v0, pipeExt, pipeInt, state) {
		...
		return _List_fromArray(
			[
				...
				switch (_v1.$) {
					case 'ByPage':
						return A3($author$project$Components$Internal$Toolbar$toolbarMenuPagination, pipeExt, pipeInt, state);
					case 'Limit':
						return A3($author$project$Components$Internal$Toolbar$toolbarMenuPagination, pipeExt, pipeInt, state);
					default:
						return $rtfeldman$elm_css$Html$Styled$text('');
...
var $author$project$Components$Internal$Table$tableHeader = F5(
	function (config, toolbarState, pipeExt, pipeInt, state) {
		var cfg = config.a;
		var toolbarContainerStyles = _List_fromArray(
			[
				$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$p_4,
				$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$bg_color($matheus23$elm_default_tailwind_modules$Tailwind$Theme$gray_100)
			]);
		var stickyStyles = cfg.stickyHeader ? _List_fromArray(
			[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$sticky, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$top_0, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$z_10]) : _List_Nil;
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
			...
			_Utils_ap(
					...
					[
						...
						_List_fromArray(
							[
								...
								_Utils_ap(
									_List_fromArray(
										[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$flex, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$flex_wrap, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$gap_2]),
				...
				A2(
					$elm$core$List$map,
					function (f) {
						return A2(f, toolbarContainerStyles, toolbarState);
					},
					cfg.toolbarContainer)));
	});
...
var $author$project$Components$Internal$Table$view = F3(
	function (config, toolbarState, model) {
		var m = model.a;
			...
			return A2(
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$Attributes$css(
						_List_fromArray(
							[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$flex, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$justify_center, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$items_center, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$h_32]))
					]),
				_List_fromArray(
					[
						A2(
			...
			function () {
				...
				switch (_v0.a.$) {
					case 'Status':
						...
						return _List_fromArray(
							[
								A5($author$project$Components$Internal$Table$tableHeader, config, toolbarState, pipeExt, pipeInt, m.state),
								bigText(msg)
							]);
					case 'Loaded':
						var total = _v0.a.a.total;
...
var $author$project$Components$Table$Table$view = $author$project$Components$Internal$Table$view;
var $author$project$Components$UaTable$view = function (model) {
	return A3(
		$author$project$Components$Table$Table$view,
		$author$project$Components$UaTable$config(model.smallScreen),
		model.toolbarState,
		model.table);
};
		...
		A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[$matheus23$elm_default_tailwind_modules$Tailwind$Utilities$w_screen, $matheus23$elm_default_tailwind_modules$Tailwind$Utilities$mx_auto]))
				]),
			_List_fromArray(
				[
...
_Platform_export({'View':{'init':$author$project$View$main($elm$json$Json$Decode$string)(0)}});}(this));